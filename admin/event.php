<?php
/*
    In this page,  php script will show the all events which are stored on database.
    these events are only visible for admin
*/
//session start
session_start();
...
// for get success and error messges
...
<section class="container admin-section mt-5 mb-5" >
    <div class="row heading-row mb-5">
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
            <h1 class="text-danger font-weight-bold">Event's</h1>
            <div class="mt-4">
    ...
    <div class="row filter-row">
        <div class="col-sm-12 col-md-12 col-lg-12 filter-record">
            <div class="content d-flex justify-content-between flex-row w-100">
                <div class="add-btn">
                    <a href="add_event.php" class=" bg-info " style="margin-bottom: 10px !important;">Add Event</a>
                </div>
            </div><!--content-->
        </div>
    </div><!--filter-row-->
    ...
    <div class="row table-row">
        <div class="col-sm-12 col-md12 col-lg-12 program-table ">
            <table class="table table-striped table-hover table-bordered table-responsive-md">
                ...
                <?php
                // fetch all the events and display them
                    $query = "SELECT * FROM child_event";
                ...
                <tr>
                    ...
                    <td>
                        <a href="update_event.php?id=<?php echo $id; ?>" class="btn btn-success text-light btn-sm font-weight-bold ">Update</a>
                        <a href="delete_event.php?id=<?php echo $id; ?>" class="btn btn-danger text-light btn-sm font-weight-bold">Delete</a>
                    </td>
                </tr>
                <?php
                     }//while

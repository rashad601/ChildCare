<?php
/*
    In this page, admin can see all programs and also add, delete and update them
*/
//session start
session_start();
// require files
...
<section class="container admin-section mt-5 mb-5" >
    <div class="row heading-row mb-5">
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
            <h1 class="text-danger font-weight-bold">Programs</h1>
            <div class="mt-4">
    ...
    <div class="row filter-row">
        <div class="col-sm-12 col-md-12 col-lg-12 filter-record">
            <div class="content d-flex justify-content-between flex-row w-100">
                <div class="add-btn">
                    <a href="add_program.php" class=" mr-2 mt-4 bg-success" style="margin-bottom: 10px !important;">Add Program</a>
                </div>
            </div><!--content-->
        </div>
    </div><!--filter-row-->
        ...
        <div class="col-sm-12 col-md12 col-lg-12 program-table ">
            <table class="table table-striped table-hover table-bordered table-responsive-md">
                ...
                <tr>
                    ...
                    <td>
                        <a href="update_program.php?id=<?php echo $id; ?>" class="btn btn-success text-light btn-sm font-weight-bold ">Update</a>
                        <a href="delete_program.php?id=<?php echo $id; ?>" class="btn btn-danger text-light btn-sm font-weight-bold">Delete</a>
                    </td>
                </tr>
                <?php
                     }//while

<?php
/*
    All the script in this page update activity data into database and
...
if(isset($_GET['id'])){
    $activity_id = $_GET['id'];
    $query ="SELECT * FROM activity WHERE id = $activity_id";
...
if(isset($_POST['update-activity']) && isset($_FILES['image'])) { // check: if user update activity
    // get input data
    // htmlentities() convert some characters into html entities
    // this is used for security purpose

    //  Getting activity input data
    ...
    if(empty($error_array)){
        // Update Activity
        // execute query
        $query = "UPDATE activity SET title = '$title', activity_date = '$date', start_time = '$start_time', end_time = '$end_time', description = '$message', image = '$image' WHERE id = '$id'";
...
<section class="container admin-section mt-5 mb-5">
    <div class="row heading-row mb-5">
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
            <h1 class="text-danger font-weight-bold"> Update Activity</h1>
            <div class="mt-4">
    ...
    <div class="row add-staff-row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2 staff-form">
            <form method="post" action="update_activity.php" enctype="multipart/form-data">

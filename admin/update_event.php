<?php
/*
    All the script in this page update events data into database and
...
if(isset($_GET['id'])){
    $event_id = $_GET['id']; //get even id
    $query ="SELECT * FROM child_event WHERE id = $event_id"; // check if event exist into datbase then fetch specific event
...
if(isset($_POST['update-event']) && isset($_FILES['image'])) { // check: if user update events
    // get input data
    ...
    if(empty($error_array)){
        // Update events
        // execute query
        $query = "UPDATE child_event SET title = '$title', event_date = '$date', start_time = '$start_time', end_time = '$end_time', description = '$message', image = '$image' WHERE id = '$id'";
...
<section class="container admin-section mt-5 mb-5">
    <div class="row heading-row mb-5">
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
            <h1 class="text-danger font-weight-bold"> Update Event's</h1>
            <div class="mt-4">
    ...
    <div class="row add-staff-row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2 staff-form">
            <form method="post" action="update_event.php" enctype="multipart/form-data">
                ...
                <div class="row input-row row-third">
                    <div class="col-sm-12 col-md-12 col-lg-12 input">
                        <button type="submit" name="update-event" class="btn btn-md text-light btn-info  ">Update Event</button>
                    </div><!--input-->
                </div><!--input-row / third-row-->

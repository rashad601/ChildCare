<?php
/*
    All the code in this page submit event data into database and
...
// declare error array
$error_array = array();
if(isset($_POST['add-event']) && isset($_FILES['image'])) { // check: if user submit event
    // get input data
   ...
   //Image Validation
    ...
    if(empty($error_array)){
        // Insert Events
        $query = "INSERT INTO child_event (title, event_date, start_time, end_time,  description, image) VALUES ('$title', '$date', '$start_time', '$end_time', '$message',  '$image')";
...
<section class="container admin-section mt-5 mb-5">
    <div class="row heading-row mb-5">
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
            <h1 class="text-danger font-weight-bold"> Add Event's</h1>
            <div class="mt-4">
    ...
    <div class="row add-staff-row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2 staff-form">
            <form method="post" action="add_event.php" enctype="multipart/form-data">
                ...
                <div class="row input-row row-third">
                    <div class="col-sm-12 col-md-12 col-lg-12 input">
                        <button type="submit" name="add-event" class="btn btn-md text-light btn-info  ">Add Event</button>
                    </div><!--input-->
                </div><!--input-row / third-row-->

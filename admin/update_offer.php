<?php
/*
    All the script in this page update offer data from database and
...
if(isset($_POST['update-offer']) && isset($_FILES['image'])) { // check: if user update staff
    // get input data
    ...
    if(empty($error_array)){
        // Update Offer
        // execute query
        $query = "UPDATE offer SET title = '$title', price = '$price', description = '$message', image = '$image' WHERE id = '$id'";
        if(mysqli_query($connection, $query)){
            ...
            $success = "Offer Update successfully";
...
<section class="container admin-section mt-5 mb-5">
    <div class="row heading-row mb-5">
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
            <h1 class="text-danger font-weight-bold"> Update Offer's</h1>
            <div class="mt-4">
    ...
    <div class="row add-staff-row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2 staff-form">
            <form method="post" action="update_offer.php" enctype="multipart/form-data">
                ...
                <div class="row input-row row-third">
                    <div class="col-sm-12 col-md-12 col-lg-12 input">
                        <button type="submit" name="update-offer" class="btn btn-md text-light btn-info  ">Update Offer</button>
                    </div><!--input-->
                </div><!--input-row / third-row-->
